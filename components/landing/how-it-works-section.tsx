...
const steps = [
  {
    ...
    description: "Sign up at Groq Console and get your API key from the dashboard."
  },
  {
    number: 2,
  ...
  },
  {
    ...
    description: "Chat with any Groq model at unprecedented speeds with sub-second response times, all stored securely in your browser."
  }
]
